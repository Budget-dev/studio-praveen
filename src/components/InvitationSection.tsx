  ...
  return (
    <section id="invitation" className="pt-2 pb-12 px-4 md:px-8 bg-[#FAF7F2] text-center">
      <div className="max-w-4xl mx-auto w-full">
        {/* Central Ganesha Image - Large Size */}
        ...
        <div className="space-y-1">
          {/* Blessings Section - Compact spacing */}
          ...
          <div className="my-2 inline-block w-full max-w-3xl px-4">
             <div className={`py-6 border-y-2 border-secondary/20 bg-white/40 w-full flex flex-col gap-2 ${lang === 'te' ? 'font-telugu' : 'font-headline font-bold'}`}>

...
const Hero = ({ lang, onOpen, isOpen }: HeroProps) => {
  ...
  return (
    <div className={`relative transition-all duration-1000 flex items-center justify-center p-4 overflow-hidden bg-[#FAF7F2] ${isOpen ? 'h-[60vh]' : 'h-screen'}`}>
      ...
      {/* Invitation Card */}
      <div className={`relative z-10 w-full max-w-xl bg-white/90 backdrop-blur-sm border-2 border-secondary/30 rounded-[2.5rem] p-8 md:p-14 shadow-[0_20px_60px_rgba(123,48,69,0.1)] text-center animate-in fade-in zoom-in duration-1000 ${isOpen ? 'scale-95 opacity-80' : 'scale-100 opacity-100'}`}>
